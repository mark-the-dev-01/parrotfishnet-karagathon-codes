...
import GridItemCard from "components/GridItemCard/GridItemCard.js";
...
const defaultGridItemCardValue = {
  title: "",
  value: null,
  cardInfoColor: "info",
  gridItemSizes: defaultGridItemSizes,
  footerTitle: "",
...
class Dashboard extends Component {
  ...
  getTriggeredCount() {
    const triggerCount = this.state.deviceData
      .filter((d) => d.telemetry.state === "triggered")
      .filter((value, index, self) => self.indexOf(value) === index).length;

    const lastEntry = this.state.deviceData.sort(
